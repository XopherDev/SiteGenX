...
<cfif isDefined('form.submit')>
  <cfif isDefined('form.submit')>
    <cffile action="write" file="#expandPath('my_gen_homepage.html')#" output="#form.indexData#" />
    <cfset writeStatus = "siteGenTemplate_index.html has been udpated." />
  </cfif>
</cfif>
  ...
  <!-- your content here... -->
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <h1>
                Edit the static site homepage below.
            </h1>
        ...
        <cfif len(writeStatus) gt 0><cfoutput><div style="width:100%;color:red;text-align:center;font-size:20px;font-weight:bold;">#writeStatus#</div></cfoutput></cfif>
          ...
          <cffile action="read" file="#expandPath('siteGenTemplate_index.html')#" variable="fileContent">
          


            <form action="siteGen_homepage_edit.cfm" method="post" name="saveIndex">
              Edit the index.html page here:<br>
