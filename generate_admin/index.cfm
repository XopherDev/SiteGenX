    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <ul style="font-size:25px;">
                <li style="height:60px;"><a href="siteGen_index.cfm" target="_new">Generate the index page</a></li>
                <li style="height:60px;"><a href="siteGen_interior.cfm" target="_new">Generate the interior pages</a></li>
                <li style="height:60px;"><a href="siteGen_all.cfm" target="_new">Generate all pages</a></li>
            </ul>
