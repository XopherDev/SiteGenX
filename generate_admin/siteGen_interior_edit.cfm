...
<cfif isDefined('form.submit')>
  <cfif isDefined('form.submit')>
    <cffile action="write" file="#expandPath('my_gen_interior.html')#" output="#form.indexData#" />
    <cfset writeStatus = "siteGenTemplate_interior.html has been udpated." />
  </cfif>
</cfif>
  ...
  <!-- your content here... -->
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            <h1>
                Edit the static site interior pages below.
            </h1>
        ...
        <cfif len(writeStatus) gt 0><cfoutput><div style="width:100%;color:red;text-align:center;font-size:20px;font-weight:bold;">#writeStatus#</div></cfoutput></cfif>
          ...
          <cffile action="read" file="#expandPath('siteGenTemplate_interior.html')#" variable="fileContent">
          


            <form action="siteGen_interior_edit.cfm" method="post" name="saveIndex">
              Edit the interior pages here:<br>
              <textarea name="indexData" id="indexData" rows="10" cols="200"><cfoutput>#fileContent#</cfoutput></textarea>
